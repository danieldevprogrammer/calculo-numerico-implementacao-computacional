...
nome = Fore.GREEN + 'Matriz A - 20x20' + Style.RESET_ALL
print(nome)

# Matriz de coeficientes A
A = np.matrix([[25.9912, 3.5970, 9.8469, 4.2332, 34.7726, 27.3573, 42.4294, 23.7293, 32.5902, 5.2457,
                15.5347, 30.4976, 23.8243, 2.6875, 3.1043, 8.2600, 22.7991, 28.6107, 1.9863, 22.3779],
               ...
               [49.0218, 44.2264, 49.3287, 28.8533, 49.3146, 2.9371, 46.475, 42.784, 35.5059, 10.5379,
                39.8764, 21.7893, 33.5127, 44.3185, 27.8742, 29.3751, 0.9935, 33.8722, 38.0926, 19.1896]], dtype=float)

# Vetor independente b
b = np.matrix([[40.4554, 10.1067, 48.7878, 30.4491, 49.0677, 43.4887, 43.3943, 30.3153, 33.6710,
              26.7800, 40.7279, 17.5335, 33.5339, 17.1401, 0.9459, 32.7490, 5.8962, 34.1086, 36.2167, 28.7823]], dtype=float).T
